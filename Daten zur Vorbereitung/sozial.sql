...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 20. Mai 2019 um 22:50
...
CREATE TABLE `antrag` (
  ...
  `name_antrag` varchar(100) NOT NULL
...
INSERT INTO `antrag` (`ID`, `name_ID`, `frage_ID_start`, `name_antrag`) VALUES
(2, 14, 4, 'Grundsicherung'),
(7, 14, 6, 'Wohngeld');
